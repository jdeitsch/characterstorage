const WeaponProperties = {
	...
	"10": {
		"name": "Versatile",
		"desc": ["This weapon can be used with one or two hands. A damage value in parentheses appears with the propertyâ€”the damage when the weapon is used with two hands to make a melee attack."]
	},
	"11": {
		"name": "Monk",
		"desc": ["Monks gain several benefits while unarmed or weilding only monk weapons while they aren't wearing armor or wielding shields."]
	}
};
